def lannetworksacn():
 ...
 print("#"*72)
 print("\t\tWelcome To In LAN Network Scanner ")
 print("." * 72)
 print("\n\t\t\t\t*MENU* ")
 print("[1].Host-list Network with IP           [5].Scan TCP Ports")
 print("[2].Get-MAC address of an Host          [6].Scan UDP Ports")
 print("[3].Scan Open ports                     [7].OS Detection on Host")
 print("[4].Scan All ports                      [8].Scan Top 20 ports ")
 print("[9].Exit")
 print("." * 72)
 input()
